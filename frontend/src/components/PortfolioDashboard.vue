...
const portfolioCfOption = computed(() => {
...
const portfolioProdOption = computed(() => {
  const prodBreakdown = props.portfolioData?.product_breakdown
  if (!prodBreakdown) return null

  const prodEntries = Object.entries(prodBreakdown).map(([k, v]) => ({
...
const portfolioAgeOption = computed(() => {
  const ageBreakdown = props.portfolioData?.age_breakdown
    ...
    <div v-if="portfolioData" class="space-y-5">
      <div class="card p-5">
        ...
        <div class="w-full h-72">
          <BaseChart :option="portfolioCfOption" :loading="portfolioLoading" />
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div class="card p-5">
          ...
          <div class="w-full h-64">
            <BaseChart :option="portfolioProdOption" :loading="portfolioLoading" />
          </div>
        </div>
        <div class="card p-5">
          ...
          <div class="w-full h-64">
            <BaseChart :option="portfolioAgeOption" :loading="portfolioLoading" />
          </div>
        </div>
      </div>
